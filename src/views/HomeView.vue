<template>
  <div class="page">
    ...
    <p>
      현재 인프런에서 Spring Boot, JPA 강의를 보고, 프로젝트에 적용하며 기술을 익히고 있습니다.
    </p>
    <p>
    ...
    <p>저의 필요에 의해 개발하고, 아직까지 잘 사용중인 프로젝트가 있습니다.</p>
    <p>이 프로젝트를 하며 실제 사용 가능한 서비스를 만든 다는 점에서 재미와 설렘을,</p>
    ...
    <div class="column-list">
      ...
      <div style="width: 68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type: disc">
            더 나은 코드는 없을까 고민하고, 찾아보고, 조언을 구하며 프로젝트 진행
          </li>
        </ul>
      </div>
    </div>
    <div class="column-list">
      ...
      <div style="width: 68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type: disc">
            서비스가 돌아갈 정도만 빠르게 개발하고, 6개월 넘게 지속적으로 사용 중
          </li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type: disc">
    ...
    <div class="column-list">
      ...
      <div style="width: 68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type: disc">
            <mark class="highlight-blue"
              >실전! 스프링 부트와 JPA 활용2 - API 개발과 성능 최적화 (수강 중)</mark
            >
          </li>
        </ul>
        <ul class="bulleted-list">

<template>
  <div class="page">
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        <ul class="bulleted-list">
          <li style="list-style-type:disc">Spring Boot</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">Spring MVC</li>
        </ul>
        <ul class="bulleted-list">
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">HTTP API 제작 및 배포 담당</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">더 나은 코드는 없을까 고민하고, 찾아보고, 조언을 구하며 프로젝트 진행</li>
        </ul>
      </div>
    </div>
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">
            ...
            희열을 느껴 시간을 쪼개어 개발에 몰두 했음</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">서비스가 돌아갈 정도만 빠르게 개발하고,
            6개월 넘게 지속적으로 사용 중</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">
            내가 만든 것이 사람들에게 도움이 될 때,<br/>
            안정적으로 서비스를 제공할 때의 재미를 알게 됐음
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">월 간 회고 및 아침에 일어나 일과 시작하기 전, 한 문제 풀기 진행 중.</li>
        </ul>
      </div>
    </div>
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">
            ...
            개발 시간이랑 단순 작업 시간이 비슷할 것 같을 때<br />
            Python 을 이용해 작업 자동화 진행
          </li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">주식 포트폴리오 변경 알림, 파일 이름 변경, 1일 1 개발 환경 구성 등</li>
        </ul>
      </div>
    </div>
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">스프링 MVC 1편 - 백엔드 웹 개발 핵심 기술</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc"><mark class="highlight-blue">스프링 MVC 1편 - 백엔드 웹 개발 활용 기술(수강 중)</mark></li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">자바 ORM 표준 JPA 프로그래밍 - 기본편</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">실전! 스프링 부트와 JPA 활용1 - 웹 애플리케이션 개발</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc"><mark class="highlight-blue">실전! 스프링 부트와 JPA 활용2 - API 개발과 성능 최적화 (수강 중)</mark></li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">모든 개발자를 위한 HTTP 기본 웹 지식</li>
        </ul>
      </div>
    </div>
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        <ul class="bulleted-list">
          <li style="list-style-type:disc">2022.06.17. 취득</li>
        </ul>
      </div>
    </div>
    ...
    <div class="column-list">
      ...
      <div style="width:68.75%" class="column">
        ...
        <ul class="bulleted-list">
          <li style="list-style-type:disc">각자의 위치에서 열심히 사는 사람들을 보며 꾸준히 노력해야겠다 생각함</li>
        </ul>
        <ul class="bulleted-list">
          <li style="list-style-type:disc">Python, 라즈베리 파이</li>
        </ul>
      </div>
    </div>
    <hr/>
